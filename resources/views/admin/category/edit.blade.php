<x-app-layout>
    ...
    <div
        ...
        <div>Edit Data Category</div>
    </div>

    <div class="h-full w-11/12 md:w-1/3 block mx-auto rounded-lg mb-24 shadow-lg">
    <form action="/admin-category/{{ $categories->slug }}" method="post">
        @method('put')
      @csrf
        <div class="form-control mx-4">
            ...
            <input type="text" id="name" name="name" placeholder="name..." class="input input-primary input-bordered @error('name') input-error @enderror" value="{{ $categories->name }}">
          ...
          <div class="form-control mx-4">
            ...
            <input type="text" id="slug" name="slug" placeholder="slug..." class="input input-primary input-bordered @error('slug') input-error @enderror" value="{{ $categories->slug }}">
