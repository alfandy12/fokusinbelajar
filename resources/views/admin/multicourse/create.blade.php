<x-app-layout>
    ...
    <div
        ...
        <div>Add Data Multi Course</div>
    </div>

    <div class="h-full w-11/12 md:w-1/3 block mx-auto rounded-lg mb-24 shadow-lg">
    <form action="/admin-multicourse" method="post">
      @csrf
        <div class="form-control mx-4">
            <label class="label">
              <span class="label-text" for="link">Link playlist</span>
            </label> 
            <input type="text" id="link" name="link" placeholder="https://youtube.com/playlist?list=PLFIM0718LjIVEh_d-h5wAjsdv2W4SAtkx" class="input input-primary input-bordered @error('link') input-error @enderror" value="{{ old('link') }}">
