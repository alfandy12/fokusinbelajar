...
<div>Multi Courses {{$categories->name}}</div>
    ...
    <div class="justify-items-center">
        <div class="grid grid-cols mx-2 md:grid-cols-2 lg:grid-cols gap-6">
            ...
            <div class="form-control mx-2">
                <form action="/multicourses/{{$categories->slug}}">
                    @csrf
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="flex justify-center text-xl my-5">
            <div class="max-w-sm rounded overflow-hidden shadow-lg">
                ...
                <div class="px-6 py-4">
                    <div class="font-bold text-xl mb-2 text-center">{{Str::limit($multi->title, 20, '...') }}</div>
