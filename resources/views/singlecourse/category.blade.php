...
<div class="grid justify-items-center text-center text-5xl text-green-600 font-semibold underline my-4 mx-2 mt-20">
    <div>Single Course {{ $categories->name}}</div>
    ...
    <div class="justify-items-center">
        <div class="grid grid-cols mx-2 md:grid-cols-2 lg:grid-cols gap-6">
            ...
            <div class="form-control mx-2">
                <form action="/singlecourse/category/{{ $categories->slug}}/">
                    @csrf
                ...
                <div class="flex justify-center text-xl my-5">
                    <div class="max-w-sm rounded overflow-hidden shadow-lg">
                        ...
                        <div class="px-2 pt-4 pb-2">
                            <span
                                class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">{{ $categories->name}}</span>
                        </div>
                    </div>
                </div>
            </a>
